    ...
    >
      {lead ? (
        ...
        <section className={cn("grid gap-4 p-6 text-sm leading-6 text-[#f4efe2]/62", archiveSurface)}>
          <p>The current source board has no ranked links to show yet. Start with the archive, media shelf, and official source index while the next edition is assembled.</p>
